...
<title>Emirates Shopping Cart | </title>
...
<body>
				...
				<div class="row">
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								<h4 class="pull-right">AED24.99</h4>
								<h4>
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							<img src="http://placehold.it/320x150" alt="">
							<div class="caption">
								<h4 class="pull-right">AED64.99</h4>
								<h4>
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							<img src="http://placehold.it/320x150" alt="">
							<div class="caption">
								<h4 class="pull-right">AED74.99</h4>
								<h4>
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							<img src="http://placehold.it/320x150" alt="">
							<div class="caption">
								<h4 class="pull-right">AED84.99</h4>
								<h4>
					...
					<div class="col-sm-4 col-lg-4 col-md-4">
						<div class="thumbnail">
							<img src="http://placehold.it/320x150" alt="">
							<div class="caption">
								<h4 class="pull-right">AED94.99</h4>
								<h4>
	...
	<div class="container">
		...
		<footer>
			<div class="row">
				<div class="col-lg-12">
					<p>Copyright &copy; Emirates 2017</p>
				</div>
			</div>
		</footer>
